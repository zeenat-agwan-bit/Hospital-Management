...
<body>
		...
		<nav class="navbar navbar-expand-lg navbar-dark bg-dark ">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					...
					<form class="form-inline my-2 my-lg-0" action="searchbydocspcl"
						method="post">
						<input class="form-control mr-sm-2" type="search"
							name="specialization" placeholder="Search By Specialization"
							aria-label="Search">
	...
	<div style="text-align: center; margin-bottom: 2vh;">
		...
		<a class="btn btn-primary btn-sm" href="index.jsp" role="button">
			Back </a>
