...
<title>Patient's Registration By Doctor </title>
</head>
<body>
...
<form:form action="savedocpatient"  modelAttribute="patient" method="post">
	
				<form class="form-container" >
					<h2 style="text-align:center; font-weight: bold; font-size:30px; color: white;">Patient's Registration Form :</h2>
