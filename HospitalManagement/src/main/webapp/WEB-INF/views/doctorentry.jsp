				...
				<form:form action="savedoctor" modelAttribute="doctor" method="post">
					...
					<form class="form-container shadow-lg text-white">
						...
						<div class="row">
							...
							<div class="form-group col-sm-6">
								<label class="font-weight-bold">Name :</label> <input type="text" name="dname"
							...
							<div class="form-group col-sm-6">
								<label for="exampleFormControlSelect1" class="font-weight-bold">Qualification :</label> <select
							...
							<div class="form-group col-sm-6">
								<label for="exampleFormControlSelect1" class="font-weight-bold">Specialization :</label>
