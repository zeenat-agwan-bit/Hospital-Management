	...
	<div class="col-md-6 text right">
		...
		<section class="container-fluid">
			<section class="row-justify-content-center">
				<form:form action="saverecappoint" modelAttribute="appointbooking"
					method="post">

					<form class="form-container">
						<h2
							style="text-align: center; font-weight: bold; font-size: 30px; color: white;">Booking-Entry-Form
							For Receptionist ${email}</h2>

						<div class="row">
							<div class="form-group col-sm-6">
								<label for="exampleInputEmail1"
									class="font-weight-bold text-white">Reception's Email :</label>
								<input type="text" name="receptionist.email"
							...
							<div class="form-group col-md-12 "
								...
								<a class="btn btn-primary" href="recephomea" role="button">
									Back </a>
							</div>
						</div>
					</form>
